// Vercel Serverless Function: Strava OAuth – Token Refresh
// Tauscht ein refresh_token gegen ein neues access_token (+ neues refresh_token).
...
export default async function handler(req, res) {
    ...
    try {
        ...
        return res.status(502).json({ error: 'Strava token refresh failed', detail: String(e) });
    }
}
